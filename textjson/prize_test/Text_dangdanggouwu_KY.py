...
author: daizhiwei
Project: 当当购物-超值优惠券免费领取-KY-红牛
interlinkage: https://mp.weixin.qq.com/s/XSnjurPEUBJgg0RWJskKHg
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_lanyueliang_dangdanggouwu_PY(self):
        ...
        #     '//android.widget.TextView[@text="领优惠券"]'))
        # self.assertEqual(a.text, "领优惠券")  # 跳转奖品页面之后，对比title，看是否领取成功
        # print("页面正常")
        # time.sleep(5)
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/当当购物-超值优惠券免费领取-KY-红牛.png')
        print("测试通过")
        time.sleep(10)
