'''
project:滴滴代驾-代驾券礼包免费领取（有效期2021.6.30）
url: https://z.didi.cn/yiwuyima
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_didachuxing(self):
        ...
        # print("页面正常")
        # time.sleep(5)
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/嘀嗒出行-领取顺风车5折打车券.png')
        print("测试通过")
        time.sleep(10)
