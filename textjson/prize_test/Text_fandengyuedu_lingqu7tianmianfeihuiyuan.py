...
author: daizhiwei
Project: 樊登阅读-领取7天免费会员
interlinkage: https://card.dushu.io/generalize/welcome/welcome.html?r=9s0luacxzz52f8o1&py=1#/
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_fandengyuedu_lingqu7tianmianfeihuiyuan(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').click()
        time.sleep(1)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
        'https://card.dushu.io/generalize/welcome/welcome.html?r=9s0luacxzz52f8o1&py=1#/')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/樊登阅读-领取7天免费会员.png')
        print("页面正常")
        time.sleep(10)
