...
author: daizhiwei
健力宝京东电商券（满5元减3元）（有效期：2021.03.11）
https://txzj-isv.isvjcloud.com/collect_shop/home?a=TWxYZ2kwRFllb1dVM1NaVlZB
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_elema_zhike(self):
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/健力宝京东电商券（满5元减3元）.png')
        print("页面正常")
        time.sleep(10)
