...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_jingdongjingrong(self):
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/京东金融-领10元现金红包.png')
        print("页面正常")
        time.sleep(10)
