...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_lanyueliang_jingdong50yuanyouhuijuan(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').click()
        time.sleep(1)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'http://coupon.m.jd.com/coupons/show.action?key=dfedf5c7a3674131a5169b40a89a6889&roleId=42325056&to=item.jd.com/61717436274.html')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/蓝月亮-京东旗舰店50元优惠券.png')
        print("页面正常")
        time.sleep(10)
