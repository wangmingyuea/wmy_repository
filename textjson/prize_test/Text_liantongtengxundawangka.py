...
author: daizhiwei
联通腾讯大王卡-超100款APP免流-直客(无到期时间)
https://api.qcoder.com.cn/webService/shopGather/lttxdwk/tencentKing.html
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_Text_API_liantongtengxundawangka(self):
        time.sleep(2)
        ...
        time.sleep(2)
        TouchAction (self.driver).tap (x=407.2, y=813.7).release ( ).perform ( )  # 点击链接
        time.sleep(20)
        # for i in range (1):
        #     loc = ("xpath", "//*[@text='确定']")
        #     try:
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/联通腾讯大王卡-超100款APP免流-直客.png')
        print("页面正常")
        time.sleep(10)
