...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_meituanwaimai_HM(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').click()
        time.sleep(1)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys('https://c.guanggao.com/t?c=346_16_802_20')
        time.sleep(1)
        ...
        # time.sleep(8)
        # TouchAction(self.driver).tap(x=749.2,y=1138.5).release().perform()
        time.sleep(15)
        # a=self.driver.find_element_by_id('com.tencent.mm:id/dp0').text
        # print(a)
        # for i in range (1):
        #     # loc = ("xpath", "//*[@text='确定']")
        #
        ...
        #     '//android.widget.TextView[@text="美团外卖新人大礼包"]'))
        # self.assertEqual(a.text, "美团外卖新人大礼包")  # 跳转奖品页面之后，对比title，看是否领取成功
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/美团外卖-最高18元新人大礼包-HM.png')
        print("页面正常")
        time.sleep(10)
