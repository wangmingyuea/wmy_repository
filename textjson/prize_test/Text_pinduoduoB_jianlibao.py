...
author: daizhiwei
Project: 拼多多B-健力宝
interlinkage:	https://mobile.yangkeduo.com/duo_collection.html?pid=8932311_175241624&auto_open=1&dis_t=1&
cpsSign=CR_201009_8932311_175241624_60f9faa6b1402966170101a5ef408a74&range_items=2%3A250%3A1000&duoduo_type=2
'''
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_pinduoduo_B_jiaduobao(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'https://mobile.yangkeduo.com/duo_collection.html?pid=8932311_181597071&__page=dynamic')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/拼多多B-健力宝.png')
        print("页面正常")
        time.sleep(10)
