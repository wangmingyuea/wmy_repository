...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_pinduoduo_B2_jianlibao(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'https://mobile.yangkeduo.com/duo_collection.html?pid=8932311_176281877&auto_open=1&dis_t=1'
            '&cpsSign=CR_201017_8932311_176281877_a6790b932519ae3a63466e9f7dd3e572&range_items=2%3A250%3A1000&duoduo_type=2')
        time.sleep(1)
        ...
        # self.driver.find_element_by_id('com.tencent.mm:id/dn').click()
        # print("eles")
        # # self.assertEqual(eles.text, "拼多多")  # 跳转奖品页面之后，对比title，看是否领取成功
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/拼多多B-洽洽.png')
        print("页面正常")
        time.sleep(10)
