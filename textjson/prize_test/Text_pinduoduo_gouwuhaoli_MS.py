...
author: daizhiwei
Project: 拼多多-购物好礼好券限时领取-MS
interlinkage:	https://duoduo.disonn.com/h5/index.html?store_id=29
'''
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_pinduoduo_B_jiaduobao(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'https://duoduo.disonn.com/h5/index.html?store_id=29')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/拼多多-购物好礼好券限时领取-MS.png')
        print("页面正常")
        time.sleep(10)
