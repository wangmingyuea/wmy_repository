...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_shansong(self):
        ...
        #     '//android.widget.TextView[@text="闪送优惠券"]'))
        # self.assertEqual(a.text, "闪送优惠券")  # 跳转奖品页面之后，对比title，看是否领取成功
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/闪送-新用户88折优惠券.png')
        print("页面正常")
        time.sleep(10)
