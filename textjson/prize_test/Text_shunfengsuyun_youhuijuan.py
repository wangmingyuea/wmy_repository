...
author: daizhiwei
Project: 顺丰速运-超值优惠券寄件立减（无到期时间）
interlinkage: https://jrn9-sf-self-creation.weixinjia.net/mobile/index?channel=2&aid=jRN9zjVk3g8ccWrj6Bjkg8pSN2vwulrd
'''
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_shunfengsuyun_youhuijuan(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').click()
        time.sleep(1)
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'https://jrn9-sf-self-creation.weixinjia.net/mobile/index?channel=2&aid=jRN9zjVk3g8ccWrj6Bjkg8pSN2vwulrd')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/顺丰速运-超值优惠券寄件立减.png')
        print("页面正常")
        time.sleep(10)
