...
interlinkage:https://huodong.f3bd.cn/taobao57109/butiebuy?scene_id=469&type=2&sn=a58d7c8417dd3f1d&spm=page_name.h5.pty-rk_out~loc-469~std-67402
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_taobaobaiyibutie(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
         'https://huodong.f3bd.cn/taobao57109/butiebuy?'
         'scene_id=5415&type=2&sn=bcf039dc28e7192c&spm=page_name.h5.pty-rk_out~loc-5415~std-67402')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/淘宝-购物补贴限时领取.png')
        print("页面正常")
        time.sleep(10)
