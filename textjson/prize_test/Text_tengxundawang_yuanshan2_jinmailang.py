...
author: daizhiwei
Project: 腾讯大王卡-超100款APP免流-远山2-今麦郎项目
interlinkage: https://www.huhabao.com/m/ed/dwkryy.html?channel=004dwkryy
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_liantongdawangka_40G(self):
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/腾讯大王卡-超100款APP免流-远山2-今麦郎项目.png')
        print("页面正常")
        time.sleep(10)
