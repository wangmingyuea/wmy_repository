...
author: daizhiwei
Project: 腾讯大王卡-超100款APP免流-远山3-加多宝
interlinkage: https://www.huhabao.com/m/ed/dwkzsml.html?channel=001dwkzsml
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_tengxundawangka_DB(self):
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/腾讯大王卡-超100款APP免流-远山3-加多宝.png')
        print("页面正常")
        time.sleep(10)
