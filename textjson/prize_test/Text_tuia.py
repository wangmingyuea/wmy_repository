...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_tuia(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'https://engine.grapepie.cn/index/activity?appKey=2dHtSgioziAHZkiHzzy4x4Ux98Hy&adslotId=347977')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/推啊-翻翻有惊喜-好礼等你拿.png')
        print("页面正常")
        time.sleep(10)
