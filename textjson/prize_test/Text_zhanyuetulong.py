...
author: daizhiwei
Project: 斩月屠龙-价值30元豪华游戏礼包
interlinkage: https://d1.wenjuan.link/s?z=wenjuan&c=354&op=1&_sp=3
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_youaigou_qicaiyunnan(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/iy0').send_keys(
            'https://csydtg.wejesc.com/r/d2/1319.html')
        time.sleep(1)
        ...
        self.driver.get_screenshot_as_file(u'/Users/wangmingxiao/Desktop/王明月/text-python/斩月屠龙-价值30元豪华游戏礼包.png')
        print("页面正常")
        time.sleep(10)
