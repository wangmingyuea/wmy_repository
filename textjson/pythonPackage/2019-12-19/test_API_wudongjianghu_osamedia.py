...
class TestSuite_API(unittest.TestCase):
    ...
    # 定义测试武动江湖-osamedia域名链接方法
    def test_case_wudongjianghu_osamedia(self):
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath('//android.widget.TextView[@text="武动江湖"]'))
