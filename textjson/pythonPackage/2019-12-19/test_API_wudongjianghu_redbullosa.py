...
@author: daizhiwei
Project : 武动江湖API下redbullosa域名链接
'''
...
class TestSuite_API(unittest.TestCase):
    ...
    # 定义测试武动江湖-redbullosa域名链接方法
    def test_case_wudongjianghu_redbullosa(self):
        ...
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
            'http://api.redbullosa.cn/connector/theconnect/targetCon.shtml?type=3&id=2c9080e26bb0f6d6016bbc49c179001b')
