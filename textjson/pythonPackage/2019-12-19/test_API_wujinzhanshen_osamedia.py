...
@author: daizhiwei
Project : 无尽战神API下redbullmedia域名链接
'''
...
class TestSuite_API(unittest.TestCase):
    ...
    # 定义测试无尽战神-osamedia域名链接方法
    def test_case_wujinzhanshen_osamedia(self):
        ...
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys(
            'http://api.osamedia.cn/connector/theconnect/targetCon.shtml?type=3&id=2c9080e269e727c0016a002ac62c0001')
        # print('现在进行第四条链接：无尽战神-osamedia域名下链接测试')
