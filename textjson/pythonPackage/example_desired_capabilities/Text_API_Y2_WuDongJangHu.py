...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_y2wudongjianghu(self,number=2):
        # 点击微信输入框
        # 舞动江湖，领优惠券链接
        ...
        for i in range(number):
            ...
            try:
                ...
                continue
        time.sleep(6)
        TouchAction(self.driver).tap(x=1428.4, y=760.2).release().perform()
        ...
        #     :return:
        #     """
        result_file = os.popen("adb uninstall com.ql.wdjh")
