...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_AoMaiJia(self,number=1):
        # 点击微信输入框
        # 奥买家-全场10元起任选，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'https://m.aomygod.com/act-richang-waituiquanchang10yuan.html?tk=cc60WJHkcAR')
        ...
        a = WebDriverWait(self.driver, 5).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="全场10元任选 - 奥买家"]'))
        self.assertEqual(a.text, "全场10元任选 - 奥买家")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("领取成功")
