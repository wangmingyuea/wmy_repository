...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_rijiaman(self,number=1):
        # 点击微信输入框
        # 日加满官方旗舰店-10元优惠券，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
 'http://coupon.m.jd.com/coupons/show.action?key=8ce6decfc9584e5bba936434be7ae2c4&roleId=26658263&to=ichimore.jd.com')
