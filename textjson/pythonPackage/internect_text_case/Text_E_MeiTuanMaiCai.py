...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_meituanmaicai(self,number=1):
        # 点击微信输入框
        #美团买菜-领新人红包，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'https://mall.dianping.com/invite/receive.html?app_tag=union&bizId=2&code=TUMJYQUH67&poiId=182&tenantId=1&type=2')
        time.sleep(0.5)
        ...
        a = WebDriverWait(self.driver, 8).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="送你188元，1元买菜，百款商品惊爆价，还免运费哦！"]'))
        self.assertEqual(a.text, "送你188元，1元买菜，百款商品惊爆价，还免运费哦！")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("领取成功")
