...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_daiyu(self,number=1):
        # 点击微信输入框
        # 鸡脖90g*3  ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=0161764b42364d9bbea01b3e640744fa&roleId=26780785&to=youyoufood.jd.com')
