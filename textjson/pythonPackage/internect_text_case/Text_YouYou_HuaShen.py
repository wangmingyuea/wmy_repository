...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_huashen(self,number=1):
        # 点击微信输入框
        # 鸡脖90g*3  ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=1b959c4d08414ed59b87573fd299e1e1&roleId=26780730&to=youyoufood.jd.com')
