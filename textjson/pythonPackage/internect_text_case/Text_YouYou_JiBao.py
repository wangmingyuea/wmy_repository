...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_youjibao(self,number=1):
        # 点击微信输入框
        # 鸡脖90g*3  ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=31c9200fdc194fc4826baaa9a8e8af09&roleId=26780554&to=youyoufood.jd.com')
