...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_youshangpinjuan(self,number=1):
        # 点击微信输入框
        # 鸡脖90g*3  ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=c65eeddb29bc438ebc062ff5b93a2285&roleId=26780942&to=youyoufood.jd.com')
