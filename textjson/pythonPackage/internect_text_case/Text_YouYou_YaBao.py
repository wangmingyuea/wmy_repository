...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_youyagan(self,number=1):
        # 点击微信输入框
        # 鸭肝60g*3   ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=551ede88882744a0a15b1d1cf86831ed&roleId=26780679&to=youyoufood.jd.com')
