...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_youzhupi(self,number=1):
        # 点击微信输入框
        # 鸡脖90g*3  ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=12a66de98e1143a58ab6e83eca41bae3&roleId=26780614&to=youyoufood.jd.com')
