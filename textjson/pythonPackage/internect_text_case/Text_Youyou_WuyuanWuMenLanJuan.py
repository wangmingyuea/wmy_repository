...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_wuyuanjuan(self,number=1):
        # 点击微信输入框
        # 鸡脖90g*3  ，领优惠券链接
        self.driver.find_element_by_id ('com.tencent.mm:id/aqe').send_keys (
         'http://coupon.m.jd.com/coupons/show.action?key=68e9d2d6ff4546a5b568210201c98c21&roleId=26780872&to=youyoufood.jd.com')
