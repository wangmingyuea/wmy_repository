...
author: daizhiwei
Project: 安心保-免费领取80种重大疾病保障金（无到期时间）
interlinkage: https://m.95303.com/mk/zjbflPage/login/WCSD0TOBAJ16J?param1=WCSD0TOBAJ16J-1
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_anxinbao(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
        'https://m.95303.com/mk/zjbflPage/login/WCSD0TOBAJ16J?param1=WCSD0TOBAJ16J-1')
        time.sleep(1)
        ...
        self.assertEqual(a.text, "赠险")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
