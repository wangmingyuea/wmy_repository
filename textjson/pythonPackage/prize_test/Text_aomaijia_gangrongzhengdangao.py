'''
project:奥买家-港荣蒸蛋糕特价包邮
url:https://m.aomygod.com/act-richang-waituigangrong29.9.html?tk=ca20WF6Frry
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_youaigou_qicaiyunnan(self):
        ...
        'https://m.aomygod.com/act-richang-waituigangrong29.9.html?tk=ca20WF6Frry')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="港荣蒸蛋糕两箱29.9元包邮 - 奥买家"]'))
        self.assertEqual(a.text, "港荣蒸蛋糕两箱29.9元包邮 - 奥买家")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
        time.sleep(20)
