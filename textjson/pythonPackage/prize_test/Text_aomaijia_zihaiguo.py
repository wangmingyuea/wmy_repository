...
author: daizhiwei
Project: 奥买家-自嗨锅酸辣粉特价包邮（无到期时间）
interlinkage: https://m.aomygod.com/act-richang-waituisuanlafen29.9.html?tk=c470WF5uF7e
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_weida(self):
        ...
        'https://m.aomygod.com/act-richang-waituisuanlafen29.9.html?tk=c470WF5uF7e')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="自嗨锅牛肉酸辣粉券后29.9元包邮 - 奥买家"]'))
        self.assertEqual(a.text, "自嗨锅牛肉酸辣粉券后29.9元包邮 - 奥买家")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
