...
author: daizhiwei
Project: 车点点-会员专特权等你领
interlinkage:https://app.chediandian.com/cdd/monthCard/index?ApiKey=7f01e82025bf44b4a010aa3bdb38964c
&ApiST=1597035531&ApiSign=6ae007a523beb5376b7bc00df2e7998e&channel=red1
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_weida(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
          'https://app.chediandian.com/cdd/monthCard/index?ApiKey=7f01e82025bf44b4a010aa3bdb38964c&ApiST=1597035531'
          '&ApiSign=6ae007a523beb5376b7bc00df2e7998e&channel=red1')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="车点点月卡"]'))
        self.assertEqual(a.text, "车点点月卡")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
        time.sleep(5)
