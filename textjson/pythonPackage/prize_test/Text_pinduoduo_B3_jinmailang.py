...
author: daizhiwei
Project: 拼多多B3-天天领优惠-今麦郎-H5
interlinkage: https://mobile.yangkeduo.com/duo_collection.html?pid=8932311_144498893&auto_open=1&dis_t=1&cpsSign=CR_
200616_8932311_144498893_a2bdc26bf4da4cf4fd13d0689456bee4&range_items=2%3A200%3A1000&duoduo_type=2
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_pinduoduo_B3_jinmailang(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
            'https://mobile.yangkeduo.com/duo_collection.html?pid=8932311_144498893&auto_open=1&dis_t=1&cpsSign=CR_'
            '200616_8932311_144498893_a2bdc26bf4da4cf4fd13d0689456bee4&range_items=2%3A200%3A1000&duoduo_type=2')
        time.sleep(1)
