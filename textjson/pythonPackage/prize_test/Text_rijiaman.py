...
author: daizhiwei
Project: 日加满优惠券（9月28日到期）
interlinkage: http://coupon.m.jd.com/coupons/show.action?key=5114594714604f658620ad060ba11008&roleId=33870622&to=ichimore.jd.com
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_rijiaman(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
        'http://coupon.m.jd.com/coupons/show.action?key=5114594714604f658620ad060ba11008&roleId=33870622&to=ichimore.jd.com')
        time.sleep(1)
