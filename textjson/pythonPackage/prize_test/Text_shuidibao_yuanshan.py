...
author: daizhiwei
Project: 水滴保-免费领取 500元健康基金-远山
interlinkage: https://www.yuanshanbx.com/m/j/common.html?id=1969&position=game&gameId=1
'''
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_shuidibao_yuanshan(self):
        ...
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
            'https://www.yuanshanbx.com/m/j/common.html?id=1969&position=game&gameId=1')
        time.sleep(1)
