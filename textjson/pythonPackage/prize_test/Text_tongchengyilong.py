...
author: daizhiwei
Project: 同程艺龙-出行礼包等你领（无到期时间）
interlinkage: https://wx.17u.cn/marketactivity/platact/7205af0650e06ea783c5eb46d58c44bd/?wvc3=1&refid=1042074476
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_tongchengyilong(self):
        ...
        'https://wx.17u.cn/marketactivity/platact/7205af0650e06ea783c5eb46d58c44bd/?wvc3=1&refid=1042074476')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="同程旅行请你88元游全国"]'))
        self.assertEqual(a.text, "同程旅行请你88元游全国")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
