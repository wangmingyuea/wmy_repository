...
author: daizhiwei
Project: 同程艺龙-出行礼包等你领-BL（今麦郎转盘）（无到期时间）
interlinkage: https://wx.17u.cn/marketactivity/platact/cfd505f3be86eac46ae580e0313ec6c7/?wvc3=1&refid=1042078156
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_tongchengyilong_BL(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
        'https://wx.17u.cn/marketactivity/platact/cfd505f3be86eac46ae580e0313ec6c7/?wvc3=1&refid=1042078156')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="乐享出游大礼包"]'))
        self.assertEqual(a.text, "乐享出游大礼包")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
