...
author: daizhiwei
Project: 闪王城英雄-价值30元的豪华游戏礼包（9.30到期）
interlinkage: http://api.qcoder.com.cn/connector/theconnect/targetCon.shtml?type=3&id=2c9080e2711fa8e40171634426120029
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_wangchengyouxi_jiazhi30yun(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
        'http://api.qcoder.com.cn/connector/theconnect/targetCon.shtml?type=3&id=2c9080e2711fa8e40171634426120029')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="王城英雄-价值30元的豪华游戏礼包"]'))
        self.assertEqual(a.text, "王城英雄-价值30元的豪华游戏礼包")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
