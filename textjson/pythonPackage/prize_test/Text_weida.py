...
author: daizhiwei
Project: 维达-旗舰店超值满减券-PY
interlinkage:https://shop45055931.youzan.com/v2/ump/promocard/fetch?alias=n1y3qcgi&sub_kdt_id=44863763&dc_ps=2568086900908887041.200001
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_weida(self):
        ...
        'https://shop45055931.youzan.com/v2/ump/promocard/fetch?alias=n1y3qcgi&sub_kdt_id=44863763&dc_ps=2568086900908887041.200001')
        time.sleep(1)
        ...
        self.assertEqual(a.text, "领取优惠券")  # 跳转奖品页面之后，对比title，看是否领取成功
        print("页面正常")
        time.sleep(3)
