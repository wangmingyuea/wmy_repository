...
author: daizhiwei
Project: 斩月屠龙（9.30到期）
interlinkage: http://api.qcoder.com.cn/connector/theconnect/targetCon.shtml?type=3&id=2c9080e26ac55316016afdde1e4d0002
'''
import unittest
import warnings
...
class TestSuite_API(unittest.TestCase):
    ...
    def test_case_link_zhanyuetulong(self):
        time.sleep(2)
        self.driver.find_element_by_id('com.tencent.mm:id/al_').send_keys(
        'http://api.qcoder.com.cn/connector/theconnect/targetCon.shtml?type=3&id=2c9080e26ac55316016afdde1e4d0002')
        time.sleep(1)
        ...
        a = WebDriverWait(self.driver, 10).until(lambda x: x.find_element_by_xpath(
            '//android.widget.TextView[@text="斩月屠龙"]'))
