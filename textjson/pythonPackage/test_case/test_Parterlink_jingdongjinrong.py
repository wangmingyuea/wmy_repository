...
class TestSuite_Partenlink(unittest.TestCase):
    ...
    def test_case_jingdongjinrong(self):
        self.driver.find_element_by_id('com.tencent.mm:id/aqe').send_keys(
            'https://uf.jr.jd.com/up/phone/phone.html?contentParam=F502476DCA&actCode=F502476DCA&cpachflag=pq1J2qdk')
        ...
        a = WebDriverWait(self.driver, 15).until(lambda x: x.find_element_by_xpath (
            '//android.widget.TextView[@text="京东金融"]'))
        self.assertEqual(a.text, "京东金融")
