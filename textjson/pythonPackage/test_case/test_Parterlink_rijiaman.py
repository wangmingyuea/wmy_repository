...
class TestSuite_Partenlink(unittest.TestCase):
    ...
    def test_case_rijiaman(self):
        self.driver.find_element_by_id('com.tencent.mm:id/aqe').send_keys(
            'http://coupon.m.jd.com/coupons/show.action?key=b483d804508a4544849c968562662596&roleId=25904088&to=ichimore.jd.com')
